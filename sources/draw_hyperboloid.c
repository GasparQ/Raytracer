...
** Last update Wed May 27 13:56:45 2015 quentin gasparotto
*/
...
double		draw_hyperboloid(t_streight strgt, t_object *my_obj)
{
  ...
  param[1] = 2.0 * (strgt.point.x * strgt.dir.x / pow(my_obj->mesh.hyperboloid->a, 2.0) +
		    strgt.point.y * strgt.dir.y / pow(my_obj->mesh.hyperboloid->b, 2.0) -
		    strgt.point.z * strgt.dir.z / pow(my_obj->mesh.hyperboloid->c, 2.0));
